...
@section('pagetitle') Edit Profile | Admin @endsection
...
<h2 style="position: relative; left: -20px;">Edit Profile</h2>
	<form method="post" enctype="multipart/form-data">
		{{csrf_field()}}
		<input type="hidden" name="userId" value="{{$adminDetails->userID}}">  
		<input type="hidden" name="photo" value="{{$adminDetails->photo}}">  
		<table>
			<tr>
				<td>
			...
			<tr>
				<td>Name</td>
				<td><input type="text" name="name" value="{{$adminDetails->name}}"></td>
			</tr>
			<tr>
				<td>Email</td>
				<td><input type="text" name="email" value="{{$adminDetails->email}}"></td>
			</tr>
			<tr>
				<td>Gender</td>
				<td><input type="radio" name="gender"  value="Male" 
					@if($adminDetails->gender=="Male") checked @endif> Male
					<input type="radio" name="gender"  value="Female" 
					@if($adminDetails->gender=="Female") checked @endif> Female
					<input type="radio" name="gender"  value="Other" 
					@if($adminDetails->gender=="Other") checked @endif> Other
				</td>
			</tr>
			<tr>
				<td>Date of birth</td>
				<td>
					<input style="text-align: center;" name="dob" type="date" value="{{$adminDetails->dob}}"> </div>
				</td>
			</tr>
			<tr>
				<td>Address</td>
				<td><input type="text" name="address" value="{{$adminDetails->address}}"></td>
			</tr>
			<tr>
				<td>Phone</td>
				<td><input type="text" name="phone" value="{{$adminDetails->phone}}"></td>
			</tr>
			<tr>
				<td></td>
