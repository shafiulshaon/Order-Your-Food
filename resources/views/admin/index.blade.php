...
@section('pagetitle') Home | Admin @endsection
...
@section('changePass') <a href="{{route('adminChangePassword.edit', ['id' => $adminDetails->userID])}}}">Change Password</a> @endsection
	...
	<div id="float1" style="height: 110px">
		...
		<tr >
			...
			<td colspan="3" style="width: 1000px">
				...
				<div style="float:right;margin-left: 10px"><a href="{{route('admin.deleteItem', ['itemID' => $item->itemID])}}">Delete</a></div>
			</td>
			</tr>
			</div>
		</table>
		...
		<tr >
			...
			<td colspan="3" style="width: 1000px">
				...
				<div style="float:left;margin-left: 10px">Owner:{{$item->ownerName}}</div>
			   	<div style="float:right;margin-left: 10px"><a href="{{route('viewRestaurent', ['resID' => $item->userID])}}">View Details</a></div>
