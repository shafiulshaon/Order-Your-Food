...
@section('pagetitle') Order | Restaurant @endsection
...
#sticky {
	...
	<h2>Recent Pending Order List</h2>
	<br>
	<a style="color: black; font-size: 18px;" href="{{route('restaurantOrderHistory')}}">View Order History
	</a>
...
@section('validation')
	<table>
		...
		<tr>
			...
			<td>
				<a href="{{route('restaurantOrderDelivered', ['cartID' => $item->cartID])}}">Deliveried 
				</a>  |
				<a
					href="{{route('restaurantOrderPostponed', ['cartID' => $item->cartID])}}">Postponed 
