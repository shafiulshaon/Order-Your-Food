...
@section('pagetitle') Home | Customer @endsection

@section('profile') <a href="{{route('customerProfile')}}">Profile</a> @endsection
...
<form method="post">
		{{csrf_field()}}
	<h2>Welcome Customer, {{$customerDetails->name}}</h2>
	<table id="tabletop">
		<tr>
	...
	<div id="float1" style="height: 110px">
		...
		<tr >
			...
			<td colspan="3" style="width: 1000px">
				...
				<div style="float:right;margin-left: 10px"> @if($item->availability=="Yes") <a href="{{route('customerItem.addToCart', ['itemID' => $item->itemID])}}">Add to cart</a>  @endif</div>
	...
	<div id="divbox" style="float: left;">
	@foreach($restaurantDetails as $item)
	<div id="float1" style="height: 110px">
		<table style="margin-left: 30px">
		...
		<tr >
			...
			<td colspan="3" style="width: 1000px">
			   ...
			   <div style="float:right;margin-left: 10px"> <a href="{{route('customerView.restaurantDetails', ['userID' => $item->userID])}}">View Restaurant Details</a></div>
