...
@section('pagetitle') Change Password | Customer @endsection
...
@section('changePass') <a href="{{route('customerChangePass.edit', ['id' => $currentInfo->userID])}}}">Change Password</a> @endsection
